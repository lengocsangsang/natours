...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG5zYW5nIiwiYSI6ImNtOGU4czNtNjJrYm4ycnIzczYxbTFib2IifQ.v0DAlTSuQGAsQjip_CwxjA';
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // THIS IS TO MAKE API CALL TO SERVER ON http://localhost:8000 AT END POINT: /api/v1/users/login
...
//ES6 MODULE SYNTAX, NOT COMMON JS SYNTAX
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51R7fNmGEZSuE1PsXh39w1VmFhFTeOFSJcCXSDfFZkqOQBl3W9vTCRawKNctM8zBWYqBwZCfeOqXsj6kCPfHFuCTm00UDr9fLr0');
          console.log(stripe);
        ...
        case 10:
          _context.prev = 10;
          _context.t0 = _context["catch"](0);
          console.log('[STRIPE.JS]bookTour - err:', _context.t0);
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', function (e) {
  ...
  console.log('🎃[updateSettings.js] userPasswordForm:', passwordCurrent, password, passwordConfirm);
...
if (bookBtn)
  ...
  bookBtn.addEventListener('click', function (e) {
    ...
    console.log('🎃[INDEX.JS] event on bookBtn - bookTour:', _stripe.bookTour);
    // STRIPE.JS/bookTour
